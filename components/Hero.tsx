    ...
    <>
      <div className='py-6 w-full dark:bg-black bg-gray-700  dark:bg-grid-white/[0.2] bg-grid-white/[0.2] relative flex flex-col sm:flex-row items-center lg:justify-around'>
        ...
        <div className="relative">
          ...
          <Image alt='' priority width={80} height={80} src='/cross.gif' className="absolute top-2 left-4" />
        </div>
        <div className="lg:mr-4 space-y-12 mt-6">
          ...
          <div className='text-center '>
            ...
            <h1
              className={`${rock_salt.className} mt-1.5 text-4xl sm:text-5xl lg:text-6xl font-extrabold text-sky-500`}>
              HORI OKO AGBI OLEH
            </h1>
          </div>
        </div>
